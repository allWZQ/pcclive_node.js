...
!(function () {
  ...
  function i() {
    for (var t = 0; t < e.length; t++) {
      utils.offset(e[t]).top <
        utils.win("scrollTop") + utils.win("clientHeight") && a(e[t]);
    }
  }
  function a(t) {
